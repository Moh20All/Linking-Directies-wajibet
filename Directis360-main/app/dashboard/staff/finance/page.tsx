...
import { checkFinanceAccess } from "@/services/staffFinanceService";
  ...
  useEffect(() => {
    const fetchAccess = async () => {
      try {
        ...
        const res = await checkFinanceAccess(token);
  ...
  if (accessState === "loading") {
    return (
      <div className="flex flex-col min-h-screen items-center justify-center bg-gradient-to-br from-purple-50 to-purple-100 p-6">
        ...
        <p className="text-gray-700 font-medium">Checking finance access...</p>
      </div>
    );
  }
